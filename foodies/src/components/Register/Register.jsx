...
const Register = () => {
  ...
  const  onSubmitHandler = async (event) => {
    ...
    if(response.status=== 201){
      toast.success("Regitration completed.. Please login");
      navigate("/login");
    }else{
          ...
          <div className="card-body p-4 p-sm-5">
            ...
            <form onSubmit={onSubmitHandler}>
              <div className="form-floating mb-3">
                <input type="text" className="form-control" id="floatingName" placeholder="Satoru Gojo" name='name' onChange={onChangeHandler} value={data.name} required/>
