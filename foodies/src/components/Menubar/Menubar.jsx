...
const Menubar = () => {
  ...
  <div className="container">
   <Link to={"/"}><img src={assets.deliveryman} alt="" height={48} width={48} className='mx-4'/></Link> 
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        <li className="nav-item">
          <Link className={active === 'home' ? "nav-link fw-bold active" : "nav-link"} onClick={() => setActive('home')} to="/">Home</Link>
        </li>
        <li className="nav-item">
      ...
      <div className="d-flex align-items-center gap-4">
          ...
          <Link to={`/cart`}>
              <div className="position-relative">
                      <img src={assets.trolley} alt="" height={32} width={32} className='position-relative'/>
